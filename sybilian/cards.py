class Card:
    ...
    def __init__(self, name: str, price: int, color: str, effect: dict, game_text: str, owner: str = None) -> None:
        ...
        :param price : price pf the card
        :param color : color of the card
        :param game_text : description of the card
        """
...
class Placeholder(Card):
    """ A object used for the interface. It's a placeholder for cards """
...
class Monster(Card):
    """ A monster is a card that cost 1 and has a kin """
...
class Spell(Card):
    """ A spell is a card that cost 0 and that has effects """
    def __init__(self, name: str, price: int, color: str, effect: dict, game_text: str, owner: str = None) -> None:
        """ Create a spell """
...
class Counterspell(Card):
    """ A Counterspell is a card that cost 0 but that can only be played
